...
export const GUESTS_LIST: Guest[] = [
  {
    ...
    descriptionLong: `O comentarista esportivo Paulo Vinícius Coelho fala sobre as obras que marcaram sua vida. Tudo isso sem deixar de lado seu assunto favorito, o futebol.`,
    spotify:
